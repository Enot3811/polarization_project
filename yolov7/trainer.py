...
def filter_eval_predictions(
    ...
    """
    Discard all the predictions whose confidence scores are less
    than a user-defined threshold.
    Then discard predictions whose IoU with the most confident predict
    of the same class are bigger than the user-defined IoU threshold.
